const serverUrl = "https://ddfiogyomeqf.usemoralis.com:2053/server";
const appId = "sYKs9CLVT7vE85cxUBzSu239a4uezDfip7EPOVwX";
...
async function login() {
  ...
  const options = {
    ...
    token_address: "0xd89b00736c50c867133ebc5bf731fdba6b29b3b7",
  };
    //User Sign In With Wallet:
    user = await Moralis.authenticate({
      ...
      //API Call to See How Many NFT's They Own
      const nftsWGMI = await Moralis.Web3API.account.getNFTsForContract(options);
      //Parse The Data
      const nftsOwned = nftsWGMI.total;

      //Auth Variable
      let authorized;

      //if authorized = true then we show content
      if(nftsOwned>0){
          authorized= true
      }
...
document.getElementById("btn-checkAuth").onclick = checkWGMI;
